...
00000000004019a0 <addval_273>: // movq %rax,%rdi movl %eax,%edi
  4019a0:	8d 87 48 89 c7 c3    	lea    -0x3c3876b8(%rdi),%eax
  4019a6:	c3                   	retq   

00000000004019a7 <addval_219>: //popq %rax
...
00000000004019c3 <setval_426>: //movq %rax,%rdi movl %eax,%edi
  4019c3:	c7 07 48 89 c7 90    	movl   $0x90c78948,(%rdi)
  4019c9:	c3                   	retq   

00000000004019ca <getval_280>: //popq %rax
...
00000000004019db <getval_481>: //movl %eax,%edx
...
00000000004019ef <addval_490>: //two byte nop 
...
00000000004019fc <setval_384>: //two byte nop
  4019fc:	c7 07 81 d1 84 c0    	movl   $0xc084d181,(%rdi)
  401a02:	c3                   	retq   

0000000000401a03 <addval_190>: //movq %rsp,%rax movl %esp,%eax
  401a03:	8d 87 41 48 89 e0    	lea    -0x1f76b7bf(%rdi),%eax
  401a09:	c3                   	retq   

0000000000401a0a <setval_276>: //two byte nop
  401a0a:	c7 07 88 c2 08 c9    	movl   $0xc908c288,(%rdi)
  401a10:	c3                   	retq   

0000000000401a11 <addval_436>: //movl %ecx,%esi
...
0000000000401a25 <addval_187>: //movl %ecx,%esi + two byte nop
  401a25:	8d 87 89 ce 38 c0    	lea    -0x3fc73177(%rdi),%eax
  401a2b:	c3                   	retq   

0000000000401a2c <setval_248>: //two byte nop
  401a2c:	c7 07 81 ce 08 db    	movl   $0xdb08ce81,(%rdi)
  401a32:	c3                   	retq   

0000000000401a33 <getval_159>: //movl %edx,%ecx two byte nop
  401a33:	b8 89 d1 38 c9       	mov    $0xc938d189,%eax
  401a38:	c3                   	retq   

0000000000401a39 <addval_110>: //movl %esp,%eax
  401a39:	8d 87 c8 89 e0 c3    	lea    -0x3c1f7638(%rdi),%eax
  401a3f:	c3                   	retq   

0000000000401a40 <addval_487>: //movl %eax,%edx two byte nop
...
0000000000401a4e <getval_272>: //two byte nop
...
0000000000401a68 <getval_311>: //movl %edx,%ecx two byte nop
...
0000000000401a75 <setval_328>: //two byte nop
  401a75:	c7 07 81 c2 38 d2    	movl   $0xd238c281,(%rdi)
  401a7b:	c3                   	retq   

0000000000401a7c <setval_450>: //two byte nop
  401a7c:	c7 07 09 ce 08 c9    	movl   $0xc908ce09,(%rdi)
  401a82:	c3                   	retq   

0000000000401a83 <addval_358>: //movl %esp,%eax
...
0000000000401aa5 <getval_472>: //two byte nop
  401aa5:	b8 8d ce 20 d2       	mov    $0xd220ce8d,%eax
  401aaa:	c3                   	retq   

0000000000401aab <setval_350>: //movq %rsp,%rax movl %esp,%eax
